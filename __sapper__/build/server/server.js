...
const Footer = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<footer><div class="${"footer-wrapper-main svelte-mqgns1"}"><div class="${"left-footer"}"><div class="${"left-footer-content"}"><div><img src="${"/img/girl-boss-logo.svg"}" alt="${""}"></div>
        <div><h3>Contact Us</h3>
          <span><a href="${"mailto:pinaygirlboss@gmail.com"}">pinaygirlboss@gmail.com</a></span>
          <br>
          <br>
          <a href="${"/page/privacy-policy"}"><h3>Privacy Policy</h3></a></div></div>
