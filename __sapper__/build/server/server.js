...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<nav class="${"svelte-11bxmgm"}"><div class="${"logo-wrapper"}"><img src="${"/pgn_logo.svg"}" alt="${""}"></div>
