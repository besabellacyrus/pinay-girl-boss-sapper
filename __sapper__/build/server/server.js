...
${validate_component(TransitionWrapper, "TransitionWrapper").$$render($$result, {}, {}, {
    ...
    <div class="${"app-division-wrapper"}"><div class="${"section-wrapper first-section-container svelte-1g6b7yj"}"><div><h1 class="${"app-decor"}">Lorem Ipsum Dolor Sit Amet</h1>
  ...
  <div class="${"main-wrap"}"><figure class="${"app-img-figure third-section"}"><img src="${"/img/home-bgs/section-three.svg"}" alt="${""}"></figure>
    <div class="${"app-division-wrapper"}"><div class="${"section-wrapper home-latest-episode-wrapper"}"><div class="${"center-section-wrapper"}"><h1 class="${"app-decor"}">Lorem Ipsum Dolor sit Amet, consectetur</h1>
          ...
          <div class="${"featured-episodes-wrapper svelte-1g6b7yj"}"><a href="${""}"><img src="${"/img/podcast-item-img.png"}" alt="${""}" class="${"svelte-1g6b7yj"}"></a>
            ...
            <a href="${""}"><img src="${"/img/podcast-item-img.png"}" alt="${""}" class="${"svelte-1g6b7yj"}"></a></div></div></div></div></div>

  <div class="${"main-wrap"}"><figure class="${"app-img-figure fourth-section"}"><img src="${"/img/home-bgs/section-four.svg"}" alt="${""}"></figure>
    <div class="${"app-division-wrapper"}"><div class="${"section-wrapper"}"><div class="${"center-section-wrapper home-about-us svelte-1g6b7yj"}"><h1 class="${"app-decor svelte-1g6b7yj"}">About Us</h1>
          <div class="${"about-us-founders svelte-1g6b7yj"}"><div><img src="${"/img/founder-two.png"}" alt="${""}" class="${"svelte-1g6b7yj"}">
              <h3 class="${"svelte-1g6b7yj"}">Name Here</h3>
              <p class="${"svelte-1g6b7yj"}">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum
                ab nam commodi officiis eius maiores illum est repudiandae
                accusantium. Quisquam blanditiis provident, distinctio error
                corrupti nemo! Soluta similique voluptatibus sint vel at! Fugit,
                asperiores!
            ...
            <div><img src="${"/img/founder-one.png"}" alt="${""}" class="${"svelte-1g6b7yj"}">
              <h3 class="${"svelte-1g6b7yj"}">Name Here</h3>
              <p class="${"svelte-1g6b7yj"}">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum
                ab nam commodi officiis eius maiores illum est repudiandae
                accusantium. Quisquam blanditiis provident, distinctio error
              ...
              <div class="${"social-media svelte-1g6b7yj"}"><div class="${"svelte-1g6b7yj"}"><a href="${""}"><img src="${"/img/facebook.svg"}" alt="${""}" class="${"svelte-1g6b7yj"}"></a></div>
                <div class="${"svelte-1g6b7yj"}"><a href="${""}"><img src="${"/img/instagram.svg"}" alt="${""}" class="${"svelte-1g6b7yj"}"></a></div>
                <div class="${"svelte-1g6b7yj"}"><a href="${""}"><img src="${"/img/linkedin.svg"}" alt="${""}" class="${"svelte-1g6b7yj"}"></a></div></div></div></div></div></div></div></div>

  <div class="${"main-wrap fifth-section"}"><figure class="${"app-img-figure"}"><img src="${"/img/home-bgs/section-five.svg"}" alt="${""}"></figure>
    <div class="${"app-division-wrapper fifth-section-wrapper"}"><div class="${"section-wrapper"}"><div class="${"center-section-wrapper home-contact-us svelte-1g6b7yj"}"><h1 class="${"app-decor svelte-1g6b7yj"}">Contact Us</h1>
          ...
          <form action="${""}" class="${"svelte-1g6b7yj"}"><label for="${""}">Email</label>
            ...
            <button class="${"svelte-1g6b7yj"}">Lorem Ipsum</button></form></div></div></div></div>`
	})}`;
});
