...
${validate_component(TransitionWrapper, "TransitionWrapper").$$render($$result, {}, {}, {
  ...
  <div class="${"main-wrap"}"><figure class="${"app-img-figure third-section"}"><img src="${"/img/home-bgs/section-three.svg"}" alt="${""}"></figure>
    <div class="${"app-division-wrapper"}"><div class="${"section-wrapper home-latest-episode-wrapper"}"><div class="${"center-section-wrapper"}"><h1 class="${"app-decor"}">Listen to Our Podcast</h1>
          <p class="${"my-10"}">Our Latest Episode</p>
          <div class="${"player-wrapper svelte-1en2oig"}"><div class="${"player svelte-1en2oig"}"><iframe src="${"https://anchor.fm/pinaygirlboss/embed/episodes/PGB-Ep--3-Too-Young-to-be-a-Boss--No-way--Plus-Insights-on-the-Crystals-Business-ei9dvi/a-a2vii3a"}" frameborder="${"0"}" scrolling="${"no"}" class="${"svelte-1en2oig"}"></iframe></div></div>
          <p class="${"my-20"}">More Episodes</p>
          <div class="${"featured-episodes-wrapper svelte-1en2oig"}"><a href="${"episodes/pgb-ep-3-too-young-to-be-a-boss-no-way-plus-insights-on-the-crystals-business"}"><img src="${"http://pinaygirlboss.com/wp-api/wp-content/uploads/2020/08/8236594-1597690550284-bbfb218972d86.jpg"}" alt="${""}" class="${"svelte-1en2oig"}"></a>
            <a href="${"episodes/pgb-ep-2-no-such-thing-as-the-business-in-your-head-create-your-own-niche"}"><img src="${"http://pinaygirlboss.com/wp-api/wp-content/uploads/2020/08/8236594-1597692584774-832687e2bea0c.jpg"}" alt="${""}" class="${"svelte-1en2oig"}"></a>
            <a href="${"episodes/pinay-girl-boss-pilot-episode"}"><img src="${"http://pinaygirlboss.com/wp-api/wp-content/uploads/2020/08/8236594-1597687157972-d6d534344340b.jpg"}" alt="${""}" class="${"svelte-1en2oig"}"></a></div></div></div></div></div>
  ...
  <div class="${"main-wrap fifth-section"}"><figure class="${"app-img-figure"}"><img src="${"/img/home-bgs/section-five.svg"}" alt="${""}"></figure>
    <div class="${"app-division-wrapper fifth-section-wrapper"}"><div class="${"section-wrapper"}"><div class="${"center-section-wrapper home-contact-us svelte-1en2oig"}"><h1 class="${"app-decor svelte-1en2oig"}">Contact Us</h1>
          <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Corporis
            est dolor harum recusandae! Nemo unde sed eum quaerat quisquam quo,
            aspernatur voluptas amet!
          </p>
          <form action="${""}" class="${"svelte-1en2oig"}"><label for="${""}">Email</label>
            <input type="${"text"}" class="${"svelte-1en2oig"}">
            <button class="${"svelte-1en2oig"}">Lorem Ipsum</button></form></div></div></div></div>`
	})}`;
});
...
${validate_component(TransitionWrapper, "TransitionWrapper").$$render($$result, {}, {}, {
  ...
  `;
			...
			return (function (data) {
				return `
    ${data.data
				? `<div class="${"single-episode-main-bg svelte-1wijmai"}"><div class="${"inner-page-wrapper"}"><h1 class="${"app-decor"}">${data.data.episode.title}</h1>
