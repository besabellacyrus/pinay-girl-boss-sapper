...
<div class="${"app-division-wrapper first-section-bg svelte-1f0mf8a"}"><div class="${"section-wrapper first-section-container svelte-1f0mf8a"}"><div><h1 class="${"app-decor"}">Lorem Ipsum Dolor Sit Amet</h1>
...
<div class="${"app-division-wrapper second-section-bg svelte-1f0mf8a"}"><div class="${"section-wrapper"}"><img src="${"/img/woman-illustration-two.svg"}" alt="${""}">
...
<div class="${"app-division-wrapper third-section-bg svelte-1f0mf8a"}"><div class="${"section-wrapper svelte-1f0mf8a"}"><div class="${"center-section-wrapper"}"><h1 class="${"app-decor"}">Lorem Ipsum Dolor sit Amet, consectetur</h1>
      <p class="${"my-10"}">Our Latest Episode</p>
      <div class="${"player-wrapper svelte-1f0mf8a"}"><div class="${"player svelte-1f0mf8a"}">1</div></div>
      <p class="${"my-20"}">More Episodes</p>
      <div class="${"featured-episodes-wrapper svelte-1f0mf8a"}"><a href="${""}"><img src="${"/img/podcast-item-img.png"}" alt="${""}" class="${"svelte-1f0mf8a"}"></a>
        <a href="${""}"><img src="${"/img/podcast-item-img.png"}" alt="${""}" class="${"svelte-1f0mf8a"}"></a>
        <a href="${""}"><img src="${"/img/podcast-item-img.png"}" alt="${""}" class="${"svelte-1f0mf8a"}"></a></div></div></div></div>

<div class="${"app-division-wrapper fourth-section-bg svelte-1f0mf8a"}"><div class="${"section-wrapper svelte-1f0mf8a"}"><div class="${"center-section-wrapper home-about-us svelte-1f0mf8a"}"><h1 class="${"app-decor svelte-1f0mf8a"}">About Us</h1>
      <div class="${"about-us-founders svelte-1f0mf8a"}"><div><img src="${"/img/founder-one.png"}" alt="${""}" class="${"svelte-1f0mf8a"}">
          <h3 class="${"svelte-1f0mf8a"}">Name Here</h3>
          <p class="${"svelte-1f0mf8a"}">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum ab
            nam commodi officiis eius maiores illum est repudiandae accusantium.
            Quisquam blanditiis provident, distinctio error corrupti nemo!
            Soluta similique voluptatibus sint vel at! Fugit, asperiores!
          </p>
          <div class="${"social-media svelte-1f0mf8a"}"><div class="${"svelte-1f0mf8a"}"><a href="${""}"><img src="${"/img/facebook.svg"}" alt="${""}" class="${"svelte-1f0mf8a"}"></a></div>
            <div class="${"svelte-1f0mf8a"}"><a href="${""}"><img src="${"/img/instagram.svg"}" alt="${""}" class="${"svelte-1f0mf8a"}"></a></div>
            <div class="${"svelte-1f0mf8a"}"><a href="${""}"><img src="${"/img/linkedin.svg"}" alt="${""}" class="${"svelte-1f0mf8a"}"></a></div></div></div>
        <div><img src="${"/img/founder-two.png"}" alt="${""}" class="${"svelte-1f0mf8a"}">
          <h3 class="${"svelte-1f0mf8a"}">Name Here</h3>
          <p class="${"svelte-1f0mf8a"}">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum ab
            nam commodi officiis eius maiores illum est repudiandae accusantium.
            Quisquam blanditiis provident, distinctio error corrupti nemo!
          ...
          <div class="${"social-media svelte-1f0mf8a"}"><div class="${"svelte-1f0mf8a"}"><a href="${""}"><img src="${"/img/facebook.svg"}" alt="${""}" class="${"svelte-1f0mf8a"}"></a></div>
            <div class="${"svelte-1f0mf8a"}"><a href="${""}"><img src="${"/img/instagram.svg"}" alt="${""}" class="${"svelte-1f0mf8a"}"></a></div>
            <div class="${"svelte-1f0mf8a"}"><a href="${""}"><img src="${"/img/linkedin.svg"}" alt="${""}" class="${"svelte-1f0mf8a"}"></a></div></div></div></div></div></div></div>

<div class="${"app-division-wrapper fifth-section-bg svelte-1f0mf8a"}"><div class="${"section-wrapper svelte-1f0mf8a"}"><div class="${"center-section-wrapper home-contact-us svelte-1f0mf8a"}"><h1 class="${"app-decor svelte-1f0mf8a"}">Contact Us</h1>
      <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Corporis est
        dolor harum recusandae! Nemo unde sed eum quaerat quisquam quo,
        aspernatur voluptas amet!
      </p>
      <form action="${""}" class="${"svelte-1f0mf8a"}"><label for="${""}">Email</label>
        <input type="${"text"}" class="${"svelte-1f0mf8a"}">
        <button class="${"svelte-1f0mf8a"}">Lorem Ipsum</button></form></div></div></div>`;
});
