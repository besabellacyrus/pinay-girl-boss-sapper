        ...
        `;
          ...
          <div class="${"center-section-wrapper"}"><h1 class="${"app-decor"}">Listen to Our Podcast</h1>
            ...
            <div class="${"featured-episodes-wrapper svelte-1en2oig"}">${data.data
				? `${each(data.data.episodes.nodes, (latest, i) => `<a${add_attribute("href", "episodes/" + latest.slug, 0)}><img${add_attribute("src", latest.episodes_gql.episodeThumbnail.sourceUrl, 0)}${add_attribute("alt", latest.title, 0)} class="${"svelte-1en2oig"}">
                  </a>`)}`
				: ``}</div></div>
        `;
			})(__value);
...
${validate_component(TransitionWrapper, "TransitionWrapper").$$render($$result, {}, {}, {
        ...
        <p>We’re sharing free stuff! Printables, guides, templates, and many
          more. Watch this space and be on your road to being the boss of your
          own life.
        </p></div></div></div>
...
const OLD_EPISODES = ApolloClient.gql`
...
const Episodes = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	let episodes = svelteApollo.query(client, {
		query: OLD_EPISODES,
		variables: { first: 5, before: null, after: null }
	});
...
${validate_component(TransitionWrapper, "TransitionWrapper").$$render($$result, {}, {}, {
        ...
        <p>Join the Online Kwentuhan! We talk about anything and everything under
          the sun - business, productivity, self-love, self-care, makeup,
          workouts (or the lack of it), coffee, our love for essential oils,
          daily struggles, life phases and transitions - no holds barred. Let’s
          get inspired and learn from stories of our guests and let us know how
  ...
  <section><div class="${"podcast-lists-wrapper svelte-1a8popc"}">${(function (__value) {
      ...
      `;
        ...
        ${data.data
				...
				: `<p>ERROR!!</p>`}
        <div class="${"load-more-wrapper"}">${data.data.episodes.pageInfo.hasNextPage
				? `<button>Load More
            </button>`
				: ``}</div>
      `;
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  <div class="${"menu-desktop menu-wrapper svelte-11bxmgm"}"><ul class="${"svelte-11bxmgm"}"><li${add_attribute("aria-current", segment === undefined ? "page" : undefined, 0)} class="${"svelte-11bxmgm"}"><a href="${"/"}">Home</a></li>
      <li${add_attribute("aria-current", segment === "episodes" ? "page" : undefined, 0)} class="${"svelte-11bxmgm"}"><a href="${"episodes"}">Episodes</a></li>
      <li${add_attribute("aria-current", segment === "about" ? "page" : undefined, 0)} class="${"svelte-11bxmgm"}"><a href="${"about"}">About</a></li>
      <li${add_attribute("aria-current", segment === "resources" ? "page" : undefined, 0)} class="${"svelte-11bxmgm"}"><a href="${"resources"}">Resources</a></li>
      <li${add_attribute("aria-current", segment === "contact" ? "page" : undefined, 0)} class="${"svelte-11bxmgm"}"><a href="${"contact"}">Contact</a></li></ul>
...
const Footer = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
    ...
    <div class="${"right-footer"}"><div><div><h3>Let&#39;s Get Social!</h3>
          <div class="${"social-media"}"><div><a href="${"https://www.facebook.com/pinaygirlboss"}" target="${"_blank"}"><img src="${"/img/footer/facebook.svg"}" alt="${""}"></a></div>
            ...
            <div><a href="${"http://m.me/pinaygirlboss"}" target="${"_blank"}"><img src="${"/img/footer/messenger.svg"}" alt="${""}"></a></div></div></div></div>
...
const css$7 = {
	code: "h1.svelte-fggaky.svelte-fggaky,p.svelte-fggaky.svelte-fggaky{margin:0 auto}h1.svelte-fggaky.svelte-fggaky{font-size:2.8em;font-weight:700;margin:0 0 0.5em 0}p.svelte-fggaky.svelte-fggaky{margin:1em auto}@media(min-width: 480px){h1.svelte-fggaky.svelte-fggaky{font-size:4em}}.error-wrapper.svelte-fggaky.svelte-fggaky{color:#25577d}.error-wrapper.svelte-fggaky h1.svelte-fggaky{color:#25577d}",
	map: "{\"version\":3,\"file\":\"_error.svelte\",\"sources\":[\"_error.svelte\"],\"sourcesContent\":[\"<script>\\nexport let status;\\nexport let error;\\n\\nconst dev = undefined === \\\"development\\\";\\n</script>\\n\\n<style lang=\\\"scss\\\">h1,\\np {\\n  margin: 0 auto; }\\n\\nh1 {\\n  font-size: 2.8em;\\n  font-weight: 700;\\n  margin: 0 0 0.5em 0; }\\n\\np {\\n  margin: 1em auto; }\\n\\n@media (min-width: 480px) {\\n  h1 {\\n    font-size: 4em; } }\\n\\n.error-wrapper {\\n  color: #25577d; }\\n  .error-wrapper h1 {\\n    color: #25577d; }</style>\\n\\n<svelte:head>\\n  <title>{status}</title>\\n</svelte:head>\\n\\n<div\\n  class=\\\"app-division-wrapper default-section-header font-white about-us-main-bg\\\">\\n  <div class=\\\"section-wrapper\\\">\\n    <div class=\\\"center-section-wrapper error-wrapper\\\">\\n      <h1>{status}</h1>\\n\\n      <p>{error.message}</p>\\n\\n      {#if dev && error.stack}\\n        <pre>{error.stack}</pre>\\n      {/if}\\n    </div>\\n  </div>\\n</div>\\n\"],\"names\":[],\"mappings\":\"AAOmB,8BAAE,CACrB,CAAC,4BAAC,CAAC,AACD,MAAM,CAAE,CAAC,CAAC,IAAI,AAAE,CAAC,AAEnB,EAAE,4BAAC,CAAC,AACF,SAAS,CAAE,KAAK,CAChB,WAAW,CAAE,GAAG,CAChB,MAAM,CAAE,CAAC,CAAC,CAAC,CAAC,KAAK,CAAC,CAAC,AAAE,CAAC,AAExB,CAAC,4BAAC,CAAC,AACD,MAAM,CAAE,GAAG,CAAC,IAAI,AAAE,CAAC,AAErB,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzB,EAAE,4BAAC,CAAC,AACF,SAAS,CAAE,GAAG,AAAE,CAAC,AAAC,CAAC,AAEvB,cAAc,4BAAC,CAAC,AACd,KAAK,CAAE,OAAO,AAAE,CAAC,AACjB,4BAAc,CAAC,EAAE,cAAC,CAAC,AACjB,KAAK,CAAE,OAAO,AAAE,CAAC\"}"
};
...
<div class="${"app-division-wrapper default-section-header font-white about-us-main-bg"}"><div class="${"section-wrapper"}"><div class="${"center-section-wrapper error-wrapper svelte-fggaky"}"><h1 class="${"svelte-fggaky"}">${escape(status)}</h1>

      <p class="${"svelte-fggaky"}">${escape(error.message)}</p>
...
const U5Bslugu5D = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${($$result.head += `${($$result.title = `<title>${escape(cache.data.episode.title)}</title>`, "")}`, "")}
...
${validate_component(TransitionWrapper, "TransitionWrapper").$$render($$result, {}, {}, {
  ...
  `;
			...
			return (function (data) {
				return `
    ${data.data
				? `<div class="${"single-episode-main-bg svelte-1m605eh"}"><div class="${"inner-page-wrapper"}"><h1 class="${"app-decor episode-title"}">${data.data.episode.title}</h1>
          ...
          <div class="${"podcast-player svelte-1m605eh"}">${data.data.episode.episodes_gql.embed}</div>
          <div class="${"episode-information-wrapper svelte-1m605eh"}"><p>${escape(data.data.episode.episodes_gql.information)}</p></div></div></div>

      ${data.data.episode.episodes_gql.speaker
					? `<div class="${"common-wrapper about-speaker svelte-1m605eh"}"><h3 class="${"svelte-1m605eh"}">About the Speaker</h3>
          <div class="${"speaker-info-wrapper svelte-1m605eh"}"><div class="${"speaker-name-wrapper"}"><h4 class="${"svelte-1m605eh"}">${escape(data.data.episode.episodes_gql.speaker.authors_gql.name)}
                ${escape(data.data.episode.episodes_gql.speaker.authors_gql.surname)}</h4>
              <small class="${"svelte-1m605eh"}">${escape(data.data.episode.episodes_gql.speaker.authors_gql.profession)}</small>
              <div class="${"speaker-bio svelte-1m605eh"}">${data.data.episode.episodes_gql.speaker.authors_gql.bio}</div></div>
            <div><img src="${"img/founder-two.png"}" alt="${""}" class="${"svelte-1m605eh"}"></div></div></div>
        <div class="${"common-wrapper social-media svelte-1m605eh"}">${data.data.episode.episodes_gql.speaker.authors_gql.facebook
						? `<div class="${"svelte-1m605eh"}"><img src="${"img/instagram.svg"}" alt="${""}">
              <span>${escape(data.data.episode.episodes_gql.speaker.authors_gql.facebook)}</span></div>`
						: ``}
          ${data.data.episode.episodes_gql.speaker.authors_gql.linkedin
						? `<div class="${"svelte-1m605eh"}"><img src="${"img/linkedin.svg"}" alt="${""}">
              <span>${escape(data.data.episode.episodes_gql.speaker.authors_gql.linkedin)}</span></div>`
						: ``}
          ${data.data.episode.episodes_gql.speaker.authors_gql.instagram
						? `<div class="${"svelte-1m605eh"}"><img src="${"img/facebook.svg"}" alt="${""}">
              <span>${escape(data.data.episode.episodes_gql.speaker.authors_gql.instagram)}</span></div>`
						: ``}</div>`
					: ``}

      <div class="${"common-wrapper social-media svelte-1m605eh"}">${data.data.episode.episodes_gql.facebook && data.data.episode.episodes_gql.facebook.length > 0
					? `<div class="${"svelte-1m605eh"}"><img src="${"img/facebook.svg"}" alt="${"Facebook"}">
            ${each(data.data.episode.episodes_gql.facebook.split(","), (facebook, i) => `<span><a${add_attribute("href", "https://facebook.com/" + facebook.trim(), 0)} target="${"_blank"}">${escape(facebook.trim())}</a>
              </span>`)}</div>`
					: ``}
        ${data.data.episode.episodes_gql.facebookGroup
					? `<div class="${"svelte-1m605eh"}"><img src="${"img/facebook.svg"}" alt="${"Facebook Group"}">
            <span><a${add_attribute("href", data.data.episode.episodes_gql.facebookGroup, 0)} target="${"_blank"}">${escape(data.data.episode.episodes_gql.facebookGroup)}</a></span></div>`
					: ``}
        ${data.data.episode.episodes_gql.twitter && data.data.episode.episodes_gql.twitter.length > 0
					? `<div class="${"svelte-1m605eh"}"><img src="${"img/twitter.svg"}" alt="${"Twitter"}">
            ${each(data.data.episode.episodes_gql.twitter.split(","), (twitter, i) => `<span><a${add_attribute("href", "https://twitter.com/" + twitter.trim(), 0)} target="${"_blank"}">@${escape(twitter.trim())}</a>
              </span>`)}</div>`
					: ``}
        ${data.data.episode.episodes_gql.instagram && data.data.episode.episodes_gql.instagram.length > 0
					? `<div class="${"svelte-1m605eh"}"><img src="${"img/instagram.svg"}" alt="${"Instagram"}">
            ${each(data.data.episode.episodes_gql.instagram.split(","), (instagram, i) => `<span><a${add_attribute("href", "https://instagram.com/" + instagram.trim(), 0)} target="${"_blank"}">@${escape(instagram.trim())}
                </a></span>  `)}</div>`
					: ``}</div>

      ${data.data.episode.episodes_gql.sponsors
					? `<div class="${"common-wrapper about-resources svelte-1m605eh"}"><h3 class="${"svelte-1m605eh"}">This episode is brought to you by:</h3>
          <div>${data.data.episode.episodes_gql.sponsors}</div></div>`
					: ``}
      ${data.data.episode.episodes_gql.resources
					? `<div class="${"common-wrapper about-resources svelte-1m605eh"}"><h3 class="${"svelte-1m605eh"}">Resources</h3>
  ...
  <div class="${"common-wrapper"}"><div class="${"pagination-wrapper svelte-1m605eh"}"><div class="${"pagination-left svelte-1m605eh"}">${prev
		? `<div><h2 class="${"svelte-1m605eh"}">PREVIOUS EPISODE</h2>
            <div class="${"pagination-content-left svelte-1m605eh"}"><img${add_attribute("src", prev.episodes_gql.episodeThumbnail.sourceUrl, 0)} alt="${""}" class="${"svelte-1m605eh"}">
              <div><h3 class="${"svelte-1m605eh"}">${prev.title}</h3>
                <p class="${"svelte-1m605eh"}">${escape(prev.episodes_gql.information)}</p></div></div></div>`
		: ``}</div>
      <div class="${"pagination-right svelte-1m605eh"}">${next
		? `<div><h2 class="${"svelte-1m605eh"}">NEXT EPISODE</h2>
            <div class="${"pagination-content-right svelte-1m605eh"}"><img${add_attribute("src", next.episodes_gql.episodeThumbnail.sourceUrl, 0)} alt="${""}" class="${"svelte-1m605eh"}">
              <div><h3 class="${"svelte-1m605eh"}">${next.title}</h3>
                <p class="${"svelte-1m605eh"}">${escape(next.episodes_gql.information)}</p></div></div></div>`
		: ``}</div></div></div>`
	})}`;
});
...
${validate_component(TransitionWrapper, "TransitionWrapper").$$render($$result, {}, {}, {
		default: () => `<div class="${"app-division-wrapper default-section-header font-white\n      contact-main-bg svelte-1e50sig"}"><div class="${"section-wrapper"}"><div class="${"center-section-wrapper"}"><h1 class="${"app-decor"}">Get In Touch</h1>
        <p>Join in on the conversation! This online kwentuhan is abous us and
          YOU! Tell us what you think, did our guests inspire you to start an
          online business, or maybe pursue learning a new skill? Do you have a
          great idea about who we should invite to be the next guest? Or just
          say hi, we would love to hear from you!
...
const css$a = {
	code: ".about-us-main-bg.svelte-8e4967.svelte-8e4967{background-image:url(\"/img/about-bg.svg\")}@media screen and (max-width: 615px){}.app-spacer.svelte-8e4967.svelte-8e4967{padding:8rem}.header-label.svelte-8e4967.svelte-8e4967{text-align:center}.header-label.svelte-8e4967 h1.svelte-8e4967{font-family:Betty;padding:2rem;color:#f9db7d;font-size:4.3rem}.header-label.svelte-8e4967 span.svelte-8e4967{font-weight:bold}.header-label.svelte-8e4967 hr.svelte-8e4967{width:14rem;margin:4rem auto;border-top:1px solid #e3e3e3}@media screen and (max-width: 768px){.first-founder.svelte-8e4967.svelte-8e4967{display:flex !important;width:100%;align-items:center;flex-flow:column wrap;flex-direction:column-reverse}}.founder-wrapper.svelte-8e4967.svelte-8e4967{display:grid;grid-template-columns:1fr 1fr;padding:0 9rem}@media screen and (max-width: 768px){.founder-wrapper.svelte-8e4967.svelte-8e4967{grid-template-columns:initial;padding:0 0rem;justify-content:center}}.founder-wrapper.svelte-8e4967 .founder-photo.svelte-8e4967{margin:0 auto}.founder-wrapper.svelte-8e4967 h1.svelte-8e4967{font-family:Betty;padding:2rem;color:#25577d}.founder-wrapper.svelte-8e4967 p.svelte-8e4967{text-align:left}.founder-wrapper.svelte-8e4967 button.svelte-8e4967{margin-top:2rem;border-radius:25px;background:#f9db7d;padding:1rem 2rem;color:#fff;box-shadow:0px 21px 59px -1px #f9db7d}",
	map: "{\"version\":3,\"file\":\"about.svelte\",\"sources\":[\"about.svelte\"],\"sourcesContent\":[\"<script>\\nimport TransitionWrapper from \\\"../components/TransitionWrapper.svelte\\\";\\n</script>\\n\\n<style lang=\\\"scss\\\">.about-us-main-bg {\\n  background-image: url(\\\"/img/about-bg.svg\\\"); }\\n\\n.about-info-wrapper {\\n  max-width: 93rem;\\n  margin: 0 auto;\\n  display: grid;\\n  grid-template-columns: 1fr 1fr;\\n  grid-gap: 3rem;\\n  margin-bottom: 10rem; }\\n  .about-info-wrapper h4 {\\n    font-weight: bold; }\\n  @media screen and (max-width: 615px) {\\n    .about-info-wrapper {\\n      grid-template-columns: initial; } }\\n\\n.app-spacer {\\n  padding: 8rem; }\\n\\n.header-label {\\n  text-align: center; }\\n  .header-label h1 {\\n    font-family: Betty;\\n    padding: 2rem;\\n    color: #f9db7d;\\n    font-size: 4.3rem; }\\n  .header-label span {\\n    font-weight: bold; }\\n  .header-label hr {\\n    width: 14rem;\\n    margin: 4rem auto;\\n    border-top: 1px solid #e3e3e3; }\\n\\n@media screen and (max-width: 768px) {\\n  .first-founder {\\n    display: flex !important;\\n    width: 100%;\\n    align-items: center;\\n    flex-flow: column wrap;\\n    flex-direction: column-reverse; } }\\n\\n.founder-wrapper {\\n  display: grid;\\n  grid-template-columns: 1fr 1fr;\\n  padding: 0 9rem; }\\n  @media screen and (max-width: 768px) {\\n    .founder-wrapper {\\n      grid-template-columns: initial;\\n      padding: 0 0rem;\\n      justify-content: center; } }\\n  .founder-wrapper .founder-photo {\\n    margin: 0 auto; }\\n  .founder-wrapper h1 {\\n    font-family: Betty;\\n    padding: 2rem;\\n    color: #25577d; }\\n  .founder-wrapper p {\\n    text-align: left; }\\n  .founder-wrapper button {\\n    margin-top: 2rem;\\n    border-radius: 25px;\\n    background: #f9db7d;\\n    padding: 1rem 2rem;\\n    color: #fff;\\n    box-shadow: 0px 21px 59px -1px #f9db7d; }\\n\\n.max-content ol {\\n  text-align: left; }</style>\\n\\n<svelte:head>\\n  <title>About</title>\\n</svelte:head>\\n\\n<TransitionWrapper>\\n  <div\\n    class=\\\"app-division-wrapper default-section-header font-white\\n      about-us-main-bg\\\">\\n    <div class=\\\"section-wrapper\\\">\\n      <div class=\\\"center-section-wrapper\\\">\\n        <h1 class=\\\"app-decor\\\">Who We Are</h1>\\n        <p>\\n          Hi! We are Tina and Max, the team behind Pinay Girl Boss. Know our\\n          WHYs, why we are on this path, why we started this project, and why we\\n          want to share this space with you!\\n        </p>\\n      </div>\\n    </div>\\n  </div>\\n  <div class=\\\"plain-wrapper\\\">\\n    <div class=\\\"header-label\\\">\\n      <span>Hi there!</span>\\n      <br />\\n      <h1>We are Tina &amp; Max</h1>\\n      <hr />\\n    </div>\\n  </div>\\n  <div class=\\\"plain-wrapper\\\">\\n    <div class=\\\"founder-wrapper first-founder\\\">\\n      <div>\\n        <h1>Meet Tina</h1>\\n        <p>\\n          I am a lifelong learner and a proud product of the Philippine public\\n          school system! I went to Manila Science High School, then the\\n          University of the Philippines Diliman for my pre-law and law degrees.\\n          I have worked in government and in the international development scene\\n          for more than a decade until life happened, I became a mom to 2\\n          adorable kids and I’ve undergone a lot of mindset shifts. I became a\\n          mompreneur, became involved in mom-related advocacies, and explored my\\n          options. I am currently enjoying life as a self-employed boss mama at\\n          The Oil Natural Project, tribe leader to thousands of Young Living\\n          Essential Oil users, and community builder and co-founder of Fit Moms\\n          Project Ph and Pinay Girl Boss.\\n        </p>\\n        <a href=\\\"https://tinyurl.com/oilnatural\\\" target=\\\"_blank\\\">\\n          <button>Join Tina's Essential Oil Tribe</button>\\n        </a>\\n      </div>\\n      <div><img src=\\\"/img/Founder2.png\\\" alt=\\\"\\\" /></div>\\n    </div>\\n  </div>\\n  <div class=\\\"app-spacer\\\" />\\n  <div class=\\\"plain-wrapper\\\">\\n    <div class=\\\"founder-wrapper\\\">\\n      <div class=\\\"founder-photo\\\"><img src=\\\"/img/Founder1.png\\\" alt=\\\"\\\" /></div>\\n      <div class=\\\"max-content\\\">\\n        <h1>Meet Max</h1>\\n        <p>\\n          After graduating from the University of the Philippines Diliman, I\\n          moved back to Saudi Arabia where I started my career in the aviation\\n          industry in 2010. I am a dreamer, I am an unconventional mom, I enjoy\\n          getting lost in books, I believe that meals are not complete without\\n          dessert and I love traveling the world with my family. I am the other\\n          half of Pinay Girl Boss and proud boss mama of the Certified Oilers\\n          community.\\n        </p>\\n        <a\\n          href=\\\"https://www.youngliving.com/vo/#/signup/new-start?sponsorid=11107278&enrollerid=11107278&isocountrycode=SA&culture=en-US&type=member\\\"\\n          target=\\\"_blank\\\">\\n          <button>Join Max's Essential Oil Tribe</button>\\n        </a>\\n      </div>\\n    </div>\\n  </div>\\n  <div class=\\\"app-spacer\\\" />\\n</TransitionWrapper>\\n\"],\"names\":[],\"mappings\":\"AAImB,iBAAiB,4BAAC,CAAC,AACpC,gBAAgB,CAAE,IAAI,mBAAmB,CAAC,AAAE,CAAC,AAW7C,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AAEA,CAAC,AAEzC,WAAW,4BAAC,CAAC,AACX,OAAO,CAAE,IAAI,AAAE,CAAC,AAElB,aAAa,4BAAC,CAAC,AACb,UAAU,CAAE,MAAM,AAAE,CAAC,AACrB,2BAAa,CAAC,EAAE,cAAC,CAAC,AAChB,WAAW,CAAE,KAAK,CAClB,OAAO,CAAE,IAAI,CACb,KAAK,CAAE,OAAO,CACd,SAAS,CAAE,MAAM,AAAE,CAAC,AACtB,2BAAa,CAAC,IAAI,cAAC,CAAC,AAClB,WAAW,CAAE,IAAI,AAAE,CAAC,AACtB,2BAAa,CAAC,EAAE,cAAC,CAAC,AAChB,KAAK,CAAE,KAAK,CACZ,MAAM,CAAE,IAAI,CAAC,IAAI,CACjB,UAAU,CAAE,GAAG,CAAC,KAAK,CAAC,OAAO,AAAE,CAAC,AAEpC,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACpC,cAAc,4BAAC,CAAC,AACd,OAAO,CAAE,IAAI,CAAC,UAAU,CACxB,KAAK,CAAE,IAAI,CACX,WAAW,CAAE,MAAM,CACnB,SAAS,CAAE,MAAM,CAAC,IAAI,CACtB,cAAc,CAAE,cAAc,AAAE,CAAC,AAAC,CAAC,AAEvC,gBAAgB,4BAAC,CAAC,AAChB,OAAO,CAAE,IAAI,CACb,qBAAqB,CAAE,GAAG,CAAC,GAAG,CAC9B,OAAO,CAAE,CAAC,CAAC,IAAI,AAAE,CAAC,AAClB,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACpC,gBAAgB,4BAAC,CAAC,AAChB,qBAAqB,CAAE,OAAO,CAC9B,OAAO,CAAE,CAAC,CAAC,IAAI,CACf,eAAe,CAAE,MAAM,AAAE,CAAC,AAAC,CAAC,AAChC,8BAAgB,CAAC,cAAc,cAAC,CAAC,AAC/B,MAAM,CAAE,CAAC,CAAC,IAAI,AAAE,CAAC,AACnB,8BAAgB,CAAC,EAAE,cAAC,CAAC,AACnB,WAAW,CAAE,KAAK,CAClB,OAAO,CAAE,IAAI,CACb,KAAK,CAAE,OAAO,AAAE,CAAC,AACnB,8BAAgB,CAAC,CAAC,cAAC,CAAC,AAClB,UAAU,CAAE,IAAI,AAAE,CAAC,AACrB,8BAAgB,CAAC,MAAM,cAAC,CAAC,AACvB,UAAU,CAAE,IAAI,CAChB,aAAa,CAAE,IAAI,CACnB,UAAU,CAAE,OAAO,CACnB,OAAO,CAAE,IAAI,CAAC,IAAI,CAClB,KAAK,CAAE,IAAI,CACX,UAAU,CAAE,GAAG,CAAC,IAAI,CAAC,IAAI,CAAC,IAAI,CAAC,OAAO,AAAE,CAAC\"}"
};
...
${validate_component(TransitionWrapper, "TransitionWrapper").$$render($$result, {}, {}, {
		default: () => `<div class="${"app-division-wrapper default-section-header font-white\n      about-us-main-bg svelte-8e4967"}"><div class="${"section-wrapper"}"><div class="${"center-section-wrapper"}"><h1 class="${"app-decor"}">Who We Are</h1>
        <p>Hi! We are Tina and Max, the team behind Pinay Girl Boss. Know our
          WHYs, why we are on this path, why we started this project, and why we
          want to share this space with you!
        </p></div></div></div>
  <div class="${"plain-wrapper"}"><div class="${"header-label svelte-8e4967"}"><span class="${"svelte-8e4967"}">Hi there!</span>
      <br>
      <h1 class="${"svelte-8e4967"}">We are Tina &amp; Max</h1>
      <hr class="${"svelte-8e4967"}"></div></div>
  <div class="${"plain-wrapper"}"><div class="${"founder-wrapper first-founder svelte-8e4967"}"><div><h1 class="${"svelte-8e4967"}">Meet Tina</h1>
        <p class="${"svelte-8e4967"}">I am a lifelong learner and a proud product of the Philippine public
          school system! I went to Manila Science High School, then the
          University of the Philippines Diliman for my pre-law and law degrees.
          I have worked in government and in the international development scene
          for more than a decade until life happened, I became a mom to 2
        ...
        <a href="${"https://tinyurl.com/oilnatural"}" target="${"_blank"}"><button class="${"svelte-8e4967"}">Join Tina&#39;s Essential Oil Tribe</button></a></div>
      <div><img src="${"/img/Founder2.png"}" alt="${""}"></div></div></div>
  <div class="${"app-spacer svelte-8e4967"}"></div>
  <div class="${"plain-wrapper"}"><div class="${"founder-wrapper svelte-8e4967"}"><div class="${"founder-photo svelte-8e4967"}"><img src="${"/img/Founder1.png"}" alt="${""}"></div>
      <div class="${"max-content"}"><h1 class="${"svelte-8e4967"}">Meet Max</h1>
        <p class="${"svelte-8e4967"}">After graduating from the University of the Philippines Diliman, I
          moved back to Saudi Arabia where I started my career in the aviation
          industry in 2010. I am a dreamer, I am an unconventional mom, I enjoy
          getting lost in books, I believe that meals are not complete without
          dessert and I love traveling the world with my family. I am the other
        ...
        <a href="${"https://www.youngliving.com/vo/#/signup/new-start?sponsorid=11107278&enrollerid=11107278&isocountrycode=SA&culture=en-US&type=member"}" target="${"_blank"}"><button class="${"svelte-8e4967"}">Join Max&#39;s Essential Oil Tribe</button></a></div></div></div>
  <div class="${"app-spacer svelte-8e4967"}"></div>`
	})}`;
});
...
const css$d = {
	code: ".special-page-container.svelte-1sw6z0k{margin-top:18rem;width:1366px;min-height:800px}",
	map: "{\"version\":3,\"file\":\"[slug].svelte\",\"sources\":[\"[slug].svelte\"],\"sourcesContent\":[\"<script context=\\\"module\\\">\\r\\nimport client from \\\"../../lib/apollo\\\";\\r\\nimport { PAGE } from \\\"../../queries/page\\\";\\r\\n\\r\\nexport async function preload({ params, query }) {\\r\\n  let slug = params.slug;\\r\\n  return {\\r\\n    cache: await client.query({\\r\\n      query: PAGE,\\r\\n      variables: { slug },\\r\\n    }),\\r\\n    slug,\\r\\n  };\\r\\n}\\r\\n</script>\\r\\n\\r\\n<script>\\r\\nimport { restore, query } from \\\"svelte-apollo\\\";\\r\\n\\r\\nexport let cache;\\r\\nexport let slug;\\r\\n\\r\\nrestore(client, PAGE, cache.data);\\r\\n\\r\\nconst page = query(client, {\\r\\n  query: PAGE,\\r\\n  variables: { slug },\\r\\n});\\r\\n</script>\\r\\n\\r\\n<style lang=\\\"scss\\\">.special-page-container {\\n  margin-top: 18rem;\\n  width: 1366px;\\n  min-height: 800px; }</style>\\r\\n\\r\\n<svelte:head>\\r\\n  <title>Slug</title>\\r\\n</svelte:head>\\r\\n\\r\\n{#await cache}\\r\\n  <p>Loading...</p>\\r\\n{:then data}\\r\\n  {#if data.data}\\r\\n    <div class=\\\"app-division-wrapper\\\">\\r\\n      <div class=\\\"section-wrapper\\\">\\r\\n        <div class=\\\"special-page-container\\\">\\r\\n          <h1 class=\\\"app-decor\\\">{data.data.page.title}</h1>\\r\\n          {@html data.data.page.content}\\r\\n        </div>\\r\\n      </div>\\r\\n    </div>\\r\\n  {/if}\\r\\n{/await}\\r\\n\"],\"names\":[],\"mappings\":\"AA8BmB,uBAAuB,eAAC,CAAC,AAC1C,UAAU,CAAE,KAAK,CACjB,KAAK,CAAE,MAAM,CACb,UAAU,CAAE,KAAK,AAAE,CAAC\"}"
};
...
`;
		...
		return (function (data) {
			return `
  ${data.data
			? `<div class="${"app-division-wrapper"}"><div class="${"section-wrapper"}"><div class="${"special-page-container svelte-1sw6z0k"}"><h1 class="${"app-decor"}">${escape(data.data.page.title)}</h1>
...
const manifest = {
	...
	pages: [
...

		{
			...
			parts: [
				null,
				{ name: "page_$slug", file: "page/[slug].svelte", component: U5Bslugu5D$2, preload: preload$6, params: match => ({ slug: d(match[1]) }) }
			]
		}
	],
