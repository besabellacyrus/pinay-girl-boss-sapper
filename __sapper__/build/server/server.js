...
${validate_component(TransitionWrapper, "TransitionWrapper").$$render($$result, {}, {}, {
  ...
  `;
    ...
    ${data.data
      ...
      <div class="${"common-wrapper social-media svelte-1m605eh"}">${data.data.episode.episodes_gql.facebook
					? `<div class="${"svelte-1m605eh"}"><img src="${"img/facebook.svg"}" alt="${"Facebook"}">
            <span><a${add_attribute("href", data.data.episode.episodes_gql.facebook, 0)} target="${"_blank"}">${escape(data.data.episode.episodes_gql.facebook)}</a></span></div>`
					: ``}
        ${data.data.episode.episodes_gql.facebookGroup
        ...
        ${data.data.episode.episodes_gql.twitter
            ...
            <span><a${add_attribute("href", data.data.episode.episodes_gql.twitter, 0)} target="${"_blank"}">${escape(data.data.episode.episodes_gql.twitter)}</a></span></div>`
					: ``}
        ${data.data.episode.episodes_gql.instagram
					? `<div class="${"svelte-1m605eh"}"><img src="${"img/instagram.svg"}" alt="${"Instagram"}">
            <span><a${add_attribute("href", data.data.episode.episodes_gql.instagram, 0)} target="${"_blank"}">${escape(data.data.episode.episodes_gql.instagram)}</a></span></div>`
					: ``}</div>
