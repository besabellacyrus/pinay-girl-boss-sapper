  ...
  `;
    ...
    ${data.data
      ...
      ${data.data.episode.episodes_gql.sponsors
					? `<div class="${"common-wrapper about-resources svelte-1wijmai"}"><h3 class="${"svelte-1wijmai"}">This episode is brought to you by:</h3>
...
${validate_component(TransitionWrapper, "TransitionWrapper").$$render($$result, {}, {}, {
  ...
  <div class="${"plain-wrapper"}"><div class="${"founder-wrapper first-founder svelte-8e4967"}"><div><h1 class="${"svelte-8e4967"}">Meet Tina</h1>
        ...
        <a href="${"https://tinyurl.com/oilnatural"}" target="${"_blank"}"><button class="${"svelte-8e4967"}">Join&#39;s Tina Essential Oil Tribe</button></a></div>
  ...
  <div class="${"plain-wrapper"}"><div class="${"founder-wrapper svelte-8e4967"}"><div class="${"founder-photo svelte-8e4967"}"><img src="${"/img/Founder1.png"}" alt="${""}"></div>
      <div class="${"max-content svelte-8e4967"}"><h1 class="${"svelte-8e4967"}">Meet Max</h1>
        <ol class="${"svelte-8e4967"}"><li>30 years-old</li>
          <li>Co-Founder of Pinay Girl Boss</li>
          <li>Founder of Certified Oilers</li>
          <li>Currently working for an international Airline (celebrated my 10th
            5. year this year!)
          </li>
          <li>Mom to Lucas</li>
          <li>Wife of Arvin</li>
          <li>Queen of our house</li></ol>
        <a href="${"https://www.youngliving.com/vo/#/signup/new-start?sponsorid=11107278&enrollerid=11107278&isocountrycode=SA&culture=en-US&type=member"}" target="${"_blank"}"><button class="${"svelte-8e4967"}">Join&#39;s Max Essential Oil Tribe</button></a></div></div></div>
  <div class="${"app-spacer svelte-8e4967"}"></div>`
	})}`;
});
