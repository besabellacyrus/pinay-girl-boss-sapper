...
<div class="${"app-division-wrapper first-section-bg svelte-16v0bi5"}"><div class="${"section-wrapper first-section-container svelte-16v0bi5"}"><div><h1 class="${"app-decor"}">Lorem Ipsum Dolor Sit Amet</h1>
...
<div class="${"app-division-wrapper second-section-bg svelte-16v0bi5"}"><div class="${"section-wrapper"}"><img src="${"/img/woman-illustration-two.svg"}" alt="${""}">
...
<div class="${"app-division-wrapper third-section-bg svelte-16v0bi5"}"><div class="${"section-wrapper"}"><div class="${"center-section-wrapper"}"><h1 class="${"app-decor"}">Lorem Ipsum Dolor sit Amet, consectetur</h1>
      <p class="${"my-10"}">Our Latest Episode</p>
      <div class="${"player-wrapper svelte-16v0bi5"}"><div class="${"player svelte-16v0bi5"}">1</div></div>
      <p class="${"my-20"}">More Episodes</p>
      <div class="${"featured-episodes-wrapper svelte-16v0bi5"}"><a href="${""}"><img src="${"/img/podcast-item-img.png"}" alt="${""}" class="${"svelte-16v0bi5"}"></a>
        <a href="${""}"><img src="${"/img/podcast-item-img.png"}" alt="${""}" class="${"svelte-16v0bi5"}"></a>
        <a href="${""}"><img src="${"/img/podcast-item-img.png"}" alt="${""}" class="${"svelte-16v0bi5"}"></a></div></div></div></div>

<div class="${"app-division-wrapper fourth-section-bg svelte-16v0bi5"}"><div class="${"section-wrapper"}"><div class="${"center-section-wrapper home-about-us svelte-16v0bi5"}"><h1 class="${"app-decor svelte-16v0bi5"}">About Us</h1>
      <div class="${"about-us-founders svelte-16v0bi5"}"><div><img src="${"/img/founder-one.png"}" alt="${""}" class="${"svelte-16v0bi5"}">
          <h3 class="${"svelte-16v0bi5"}">Name Here</h3>
          <p class="${"svelte-16v0bi5"}">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum ab
            nam commodi officiis eius maiores illum est repudiandae accusantium.
            Quisquam blanditiis provident, distinctio error corrupti nemo!
            Soluta similique voluptatibus sint vel at! Fugit, asperiores!
          </p>
          <div class="${"social-media svelte-16v0bi5"}"><div class="${"svelte-16v0bi5"}"><a href="${""}"><img src="${"/img/facebook.svg"}" alt="${""}" class="${"svelte-16v0bi5"}"></a></div>
            <div class="${"svelte-16v0bi5"}"><a href="${""}"><img src="${"/img/instagram.svg"}" alt="${""}" class="${"svelte-16v0bi5"}"></a></div>
            <div class="${"svelte-16v0bi5"}"><a href="${""}"><img src="${"/img/linkedin.svg"}" alt="${""}" class="${"svelte-16v0bi5"}"></a></div></div></div>
        <div><img src="${"/img/founder-two.png"}" alt="${""}" class="${"svelte-16v0bi5"}">
          <h3 class="${"svelte-16v0bi5"}">Name Here</h3>
          <p class="${"svelte-16v0bi5"}">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum ab
            nam commodi officiis eius maiores illum est repudiandae accusantium.
            Quisquam blanditiis provident, distinctio error corrupti nemo!
          ...
          <div class="${"social-media svelte-16v0bi5"}"><div class="${"svelte-16v0bi5"}"><a href="${""}"><img src="${"/img/facebook.svg"}" alt="${""}" class="${"svelte-16v0bi5"}"></a></div>
            <div class="${"svelte-16v0bi5"}"><a href="${""}"><img src="${"/img/instagram.svg"}" alt="${""}" class="${"svelte-16v0bi5"}"></a></div>
            <div class="${"svelte-16v0bi5"}"><a href="${""}"><img src="${"/img/linkedin.svg"}" alt="${""}" class="${"svelte-16v0bi5"}"></a></div></div></div></div></div></div></div>

<div class="${"app-division-wrapper fifth-section-bg svelte-16v0bi5"}"><div class="${"section-wrapper"}"><div class="${"center-section-wrapper home-contact-us svelte-16v0bi5"}"><h1 class="${"app-decor svelte-16v0bi5"}">Contact Us</h1>
      <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Corporis est
        dolor harum recusandae! Nemo unde sed eum quaerat quisquam quo,
        aspernatur voluptas amet!
      </p>
      <form action="${""}" class="${"svelte-16v0bi5"}"><label for="${""}">Email</label>
        <input type="${"text"}" class="${"svelte-16v0bi5"}">
        <button class="${"svelte-16v0bi5"}">Lorem Ipsum</button></form></div></div></div>`;
});
