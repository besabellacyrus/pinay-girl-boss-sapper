...
const css$a = {
	code: ".about-us-main-bg.svelte-1uwm8wm.svelte-1uwm8wm{background-image:url(\"/img/about-bg.svg\")}@media screen and (max-width: 615px){}.app-spacer.svelte-1uwm8wm.svelte-1uwm8wm{padding:8rem}.header-label.svelte-1uwm8wm.svelte-1uwm8wm{text-align:center}.header-label.svelte-1uwm8wm h1.svelte-1uwm8wm{font-family:Betty;padding:2rem;color:#f9db7d;font-size:4.3rem}.header-label.svelte-1uwm8wm span.svelte-1uwm8wm{font-weight:bold}.header-label.svelte-1uwm8wm hr.svelte-1uwm8wm{width:14rem;margin:4rem auto;border-top:1px solid #e3e3e3}@media screen and (max-width: 768px){.first-founder.svelte-1uwm8wm.svelte-1uwm8wm{display:flex !important;width:100%;align-items:center;flex-flow:column wrap;flex-direction:column-reverse}}.founder-wrapper.svelte-1uwm8wm.svelte-1uwm8wm{display:grid;grid-template-columns:1fr 1fr;padding:0 9rem}@media screen and (max-width: 768px){.founder-wrapper.svelte-1uwm8wm.svelte-1uwm8wm{grid-template-columns:initial;padding:0 0rem;justify-content:center}}.founder-wrapper.svelte-1uwm8wm .founder-photo.svelte-1uwm8wm{margin:0 auto}.founder-wrapper.svelte-1uwm8wm h1.svelte-1uwm8wm{font-family:Betty;padding:2rem;color:#25577d}.founder-wrapper.svelte-1uwm8wm p.svelte-1uwm8wm{text-align:left}.founder-wrapper.svelte-1uwm8wm button.svelte-1uwm8wm{margin-top:1rem;border-radius:25px;background:#f9db7d;padding:1rem 2rem;color:#fff;box-shadow:0px 21px 59px -1px #f9db7d}.max-content.svelte-1uwm8wm ol.svelte-1uwm8wm{text-align:left}",
	map: "{\"version\":3,\"file\":\"about.svelte\",\"sources\":[\"about.svelte\"],\"sourcesContent\":[\"<script>\\nimport TransitionWrapper from \\\"../components/TransitionWrapper.svelte\\\";\\n</script>\\n\\n<style lang=\\\"scss\\\">.about-us-main-bg {\\n  background-image: url(\\\"/img/about-bg.svg\\\"); }\\n\\n.about-info-wrapper {\\n  max-width: 93rem;\\n  margin: 0 auto;\\n  display: grid;\\n  grid-template-columns: 1fr 1fr;\\n  grid-gap: 3rem;\\n  margin-bottom: 10rem; }\\n  .about-info-wrapper h4 {\\n    font-weight: bold; }\\n  @media screen and (max-width: 615px) {\\n    .about-info-wrapper {\\n      grid-template-columns: initial; } }\\n\\n.app-spacer {\\n  padding: 8rem; }\\n\\n.header-label {\\n  text-align: center; }\\n  .header-label h1 {\\n    font-family: Betty;\\n    padding: 2rem;\\n    color: #f9db7d;\\n    font-size: 4.3rem; }\\n  .header-label span {\\n    font-weight: bold; }\\n  .header-label hr {\\n    width: 14rem;\\n    margin: 4rem auto;\\n    border-top: 1px solid #e3e3e3; }\\n\\n@media screen and (max-width: 768px) {\\n  .first-founder {\\n    display: flex !important;\\n    width: 100%;\\n    align-items: center;\\n    flex-flow: column wrap;\\n    flex-direction: column-reverse; } }\\n\\n.founder-wrapper {\\n  display: grid;\\n  grid-template-columns: 1fr 1fr;\\n  padding: 0 9rem; }\\n  @media screen and (max-width: 768px) {\\n    .founder-wrapper {\\n      grid-template-columns: initial;\\n      padding: 0 0rem;\\n      justify-content: center; } }\\n  .founder-wrapper .founder-photo {\\n    margin: 0 auto; }\\n  .founder-wrapper h1 {\\n    font-family: Betty;\\n    padding: 2rem;\\n    color: #25577d; }\\n  .founder-wrapper p {\\n    text-align: left; }\\n  .founder-wrapper button {\\n    margin-top: 1rem;\\n    border-radius: 25px;\\n    background: #f9db7d;\\n    padding: 1rem 2rem;\\n    color: #fff;\\n    box-shadow: 0px 21px 59px -1px #f9db7d; }\\n\\n.max-content ol {\\n  text-align: left; }</style>\\n\\n<svelte:head>\\n  <title>About</title>\\n</svelte:head>\\n\\n<TransitionWrapper>\\n  <div\\n    class=\\\"app-division-wrapper default-section-header font-white\\n      about-us-main-bg\\\">\\n    <div class=\\\"section-wrapper\\\">\\n      <div class=\\\"center-section-wrapper\\\">\\n        <h1 class=\\\"app-decor\\\">Who We Are</h1>\\n        <p>\\n          Hi! We are Tina and Max, the team behind Pinay Girl Boss. Know our\\n          WHYs, why we are on this path, why we started this project, and why we\\n          want to share this space with you!\\n        </p>\\n      </div>\\n    </div>\\n  </div>\\n  <div class=\\\"plain-wrapper\\\">\\n    <div class=\\\"header-label\\\">\\n      <span>Hi there!</span>\\n      <br />\\n      <h1>We are Tina &amp; Max</h1>\\n      <hr />\\n    </div>\\n  </div>\\n  <div class=\\\"plain-wrapper\\\">\\n    <div class=\\\"founder-wrapper first-founder\\\">\\n      <div>\\n        <h1>Meet Tina</h1>\\n        <p>\\n          I am a lifelong learner and a proud product of the Philippine public\\n          school system! I went to Manila Science High School, then the\\n          University of the Philippines Diliman for my pre-law and law degrees.\\n          I have worked in government and in the international development scene\\n          for more than a decade until life happened, I became a mom to 2\\n          adorable kids and I’ve undergone a lot of mindset shifts. I became a\\n          mompreneur, became involved in mom-related advocacies, and explored my\\n          options. I am currently enjoying life as a self-employed boss mama at\\n          The Oil Natural Project, tribe leader to thousands of Young Living\\n          Essential Oil users, and community builder and co-founder of Fit Moms\\n          Project Ph and Pinay Girl Boss.\\n        </p>\\n        <a href=\\\"https://tinyurl.com/oilnatural\\\" target=\\\"_blank\\\">\\n          <button>Join's Tina Essential Oil Tribe</button>\\n        </a>\\n      </div>\\n      <div><img src=\\\"/img/Founder2.png\\\" alt=\\\"\\\" /></div>\\n    </div>\\n  </div>\\n  <div class=\\\"app-spacer\\\" />\\n  <div class=\\\"plain-wrapper\\\">\\n    <div class=\\\"founder-wrapper\\\">\\n      <div class=\\\"founder-photo\\\"><img src=\\\"/img/Founder1.png\\\" alt=\\\"\\\" /></div>\\n      <div class=\\\"max-content\\\">\\n        <h1>Meet Max</h1>\\n        <ol>\\n          <li>30 years-old</li>\\n          <li>Co-Founder of Pinay Girl Boss</li>\\n          <li>Founder of Certified Oilers</li>\\n          <li>\\n            Currently working for an international Airline (celebrated my 10th\\n            5. year this year!)\\n          </li>\\n          <li>Mom to Lucas</li>\\n          <li>Wife of Arvin</li>\\n          <li>Queen of our house</li>\\n        </ol>\\n        <a\\n          href=\\\"https://www.youngliving.com/vo/#/signup/new-start?sponsorid=11107278&enrollerid=11107278&isocountrycode=SA&culture=en-US&type=member\\\"\\n          target=\\\"_blank\\\">\\n          <button>Join's Max Essential Oil Tribe</button>\\n        </a>\\n      </div>\\n    </div>\\n  </div>\\n  <div class=\\\"app-spacer\\\" />\\n</TransitionWrapper>\\n\"],\"names\":[],\"mappings\":\"AAImB,iBAAiB,8BAAC,CAAC,AACpC,gBAAgB,CAAE,IAAI,mBAAmB,CAAC,AAAE,CAAC,AAW7C,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AAEA,CAAC,AAEzC,WAAW,8BAAC,CAAC,AACX,OAAO,CAAE,IAAI,AAAE,CAAC,AAElB,aAAa,8BAAC,CAAC,AACb,UAAU,CAAE,MAAM,AAAE,CAAC,AACrB,4BAAa,CAAC,EAAE,eAAC,CAAC,AAChB,WAAW,CAAE,KAAK,CAClB,OAAO,CAAE,IAAI,CACb,KAAK,CAAE,OAAO,CACd,SAAS,CAAE,MAAM,AAAE,CAAC,AACtB,4BAAa,CAAC,IAAI,eAAC,CAAC,AAClB,WAAW,CAAE,IAAI,AAAE,CAAC,AACtB,4BAAa,CAAC,EAAE,eAAC,CAAC,AAChB,KAAK,CAAE,KAAK,CACZ,MAAM,CAAE,IAAI,CAAC,IAAI,CACjB,UAAU,CAAE,GAAG,CAAC,KAAK,CAAC,OAAO,AAAE,CAAC,AAEpC,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACpC,cAAc,8BAAC,CAAC,AACd,OAAO,CAAE,IAAI,CAAC,UAAU,CACxB,KAAK,CAAE,IAAI,CACX,WAAW,CAAE,MAAM,CACnB,SAAS,CAAE,MAAM,CAAC,IAAI,CACtB,cAAc,CAAE,cAAc,AAAE,CAAC,AAAC,CAAC,AAEvC,gBAAgB,8BAAC,CAAC,AAChB,OAAO,CAAE,IAAI,CACb,qBAAqB,CAAE,GAAG,CAAC,GAAG,CAC9B,OAAO,CAAE,CAAC,CAAC,IAAI,AAAE,CAAC,AAClB,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACpC,gBAAgB,8BAAC,CAAC,AAChB,qBAAqB,CAAE,OAAO,CAC9B,OAAO,CAAE,CAAC,CAAC,IAAI,CACf,eAAe,CAAE,MAAM,AAAE,CAAC,AAAC,CAAC,AAChC,+BAAgB,CAAC,cAAc,eAAC,CAAC,AAC/B,MAAM,CAAE,CAAC,CAAC,IAAI,AAAE,CAAC,AACnB,+BAAgB,CAAC,EAAE,eAAC,CAAC,AACnB,WAAW,CAAE,KAAK,CAClB,OAAO,CAAE,IAAI,CACb,KAAK,CAAE,OAAO,AAAE,CAAC,AACnB,+BAAgB,CAAC,CAAC,eAAC,CAAC,AAClB,UAAU,CAAE,IAAI,AAAE,CAAC,AACrB,+BAAgB,CAAC,MAAM,eAAC,CAAC,AACvB,UAAU,CAAE,IAAI,CAChB,aAAa,CAAE,IAAI,CACnB,UAAU,CAAE,OAAO,CACnB,OAAO,CAAE,IAAI,CAAC,IAAI,CAClB,KAAK,CAAE,IAAI,CACX,UAAU,CAAE,GAAG,CAAC,IAAI,CAAC,IAAI,CAAC,IAAI,CAAC,OAAO,AAAE,CAAC,AAE7C,2BAAY,CAAC,EAAE,eAAC,CAAC,AACf,UAAU,CAAE,IAAI,AAAE,CAAC\"}"
};
...
${validate_component(TransitionWrapper, "TransitionWrapper").$$render($$result, {}, {}, {
		default: () => `<div class="${"app-division-wrapper default-section-header font-white\n      about-us-main-bg svelte-1uwm8wm"}"><div class="${"section-wrapper"}"><div class="${"center-section-wrapper"}"><h1 class="${"app-decor"}">Who We Are</h1>
        <p>Hi! We are Tina and Max, the team behind Pinay Girl Boss. Know our
          WHYs, why we are on this path, why we started this project, and why we
          want to share this space with you!
        </p></div></div></div>
  <div class="${"plain-wrapper"}"><div class="${"header-label svelte-1uwm8wm"}"><span class="${"svelte-1uwm8wm"}">Hi there!</span>
      <br>
      <h1 class="${"svelte-1uwm8wm"}">We are Tina &amp; Max</h1>
      <hr class="${"svelte-1uwm8wm"}"></div></div>
  <div class="${"plain-wrapper"}"><div class="${"founder-wrapper first-founder svelte-1uwm8wm"}"><div><h1 class="${"svelte-1uwm8wm"}">Meet Tina</h1>
        <p class="${"svelte-1uwm8wm"}">I am a lifelong learner and a proud product of the Philippine public
          school system! I went to Manila Science High School, then the
          University of the Philippines Diliman for my pre-law and law degrees.
          I have worked in government and in the international development scene
          for more than a decade until life happened, I became a mom to 2
        ...
        <a href="${"https://tinyurl.com/oilnatural"}" target="${"_blank"}"><button class="${"svelte-1uwm8wm"}">Join&#39;s Tina Essential Oil Tribe</button></a></div>
      <div><img src="${"/img/Founder2.png"}" alt="${""}"></div></div></div>
  <div class="${"app-spacer svelte-1uwm8wm"}"></div>
  <div class="${"plain-wrapper"}"><div class="${"founder-wrapper svelte-1uwm8wm"}"><div class="${"founder-photo svelte-1uwm8wm"}"><img src="${"/img/Founder1.png"}" alt="${""}"></div>
      <div class="${"max-content svelte-1uwm8wm"}"><h1 class="${"svelte-1uwm8wm"}">Meet Max</h1>
        <ol class="${"svelte-1uwm8wm"}"><li>30 years-old</li>
          <li>Co-Founder of Pinay Girl Boss</li>
          <li>Founder of Certified Oilers</li>
        ...
        <a href="${"https://www.youngliving.com/vo/#/signup/new-start?sponsorid=11107278&enrollerid=11107278&isocountrycode=SA&culture=en-US&type=member"}" target="${"_blank"}"><button class="${"svelte-1uwm8wm"}">Join&#39;s Max Essential Oil Tribe</button></a></div></div></div>
  <div class="${"app-spacer svelte-1uwm8wm"}"></div>`
	})}`;
});
