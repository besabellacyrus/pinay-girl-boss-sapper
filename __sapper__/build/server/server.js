...
const TransitionWrapper = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${show
	? `<div class="${"transition-wrapper svelte-1huhs37"}">${$$slots.default ? $$slots.default({}) : ``}</div>`
	: ``}`;
});
...
${validate_component(TransitionWrapper, "TransitionWrapper").$$render($$result, {}, {}, {
		default: () => `<div class="${"main-wrap"}"><figure class="${"app-img-figure svelte-1gpqo79"}"><img src="${"/img/home-bgs/section-one.svg"}" alt="${""}" class="${"svelte-1gpqo79"}"></figure>
...
${validate_component(TransitionWrapper, "TransitionWrapper").$$render($$result, {}, {}, {
		default: () => `<div class="${"app-division-wrapper font-white default-section-header\n    episode-main-bg svelte-1a8popc"}"><div class="${"section-wrapper"}"><div class="${"center-section-wrapper"}"><h1 class="${"app-decor"}">Episodes</h1>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsa,
          nostrum! Blanditiis eligendi tenetur, ipsum cum amet natus ab laborum
          odit excepturi voluptas ad!
        </p></div></div></div>
...
${validate_component(TransitionWrapper, "TransitionWrapper").$$render($$result, {}, {}, {
		default: () => `<div class="${"app-division-wrapper default-section-header font-white\n    about-us-main-bg svelte-1oiylrw"}"><div class="${"section-wrapper"}"><div class="${"center-section-wrapper"}"><h1 class="${"app-decor"}">Who We Are</h1>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsa,
          nostrum! Blanditiis eligendi tenetur, ipsum cum amet natus ab laborum
          odit excepturi voluptas ad!
        </p></div></div></div>
