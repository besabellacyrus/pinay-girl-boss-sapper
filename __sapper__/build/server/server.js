...
<div class="${"main-wrapp"}"><figure class="${"app-img-figure svelte-1gpqo79"}"><img src="${"/img/home-bgs/section-one.svg"}" alt="${""}" class="${"svelte-1gpqo79"}"></figure>
  <div class="${"app-division-wrapper"}"><div class="${"section-wrapper first-section-container svelte-1gpqo79"}"><div><h1 class="${"app-decor"}">Lorem Ipsum Dolor Sit Amet</h1>
...
<div class="${"main-wrap"}"><figure class="${"app-img-figure svelte-1gpqo79"}"><img src="${"/img/home-bgs/section-two.svg"}" alt="${""}" class="${"svelte-1gpqo79"}"></figure>
...
<div class="${"main-wrap"}"><figure class="${"app-img-figure third-section svelte-1gpqo79"}"><img src="${"/img/home-bgs/section-three.svg"}" alt="${""}" class="${"svelte-1gpqo79"}"></figure>
  <div class="${"app-division-wrapper"}"><div class="${"section-wrapper home-latest-episode-wrapper"}"><div class="${"center-section-wrapper"}"><h1 class="${"app-decor"}">Lorem Ipsum Dolor sit Amet, consectetur</h1>
        <p class="${"my-10"}">Our Latest Episode</p>
        <div class="${"player-wrapper svelte-1gpqo79"}"><div class="${"player svelte-1gpqo79"}">1</div></div>
        <p class="${"my-20"}">More Episodes</p>
        <div class="${"featured-episodes-wrapper svelte-1gpqo79"}"><a href="${""}"><img src="${"/img/podcast-item-img.png"}" alt="${""}" class="${"svelte-1gpqo79"}"></a>
          <a href="${""}"><img src="${"/img/podcast-item-img.png"}" alt="${""}" class="${"svelte-1gpqo79"}"></a>
          <a href="${""}"><img src="${"/img/podcast-item-img.png"}" alt="${""}" class="${"svelte-1gpqo79"}"></a></div></div></div></div></div>

<div class="${"main-wrap"}"><figure class="${"app-img-figure fourth-section svelte-1gpqo79"}"><img src="${"/img/home-bgs/section-four.svg"}" alt="${""}" class="${"svelte-1gpqo79"}"></figure>
  <div class="${"app-division-wrapper"}"><div class="${"section-wrapper"}"><div class="${"center-section-wrapper home-about-us svelte-1gpqo79"}"><h1 class="${"app-decor svelte-1gpqo79"}">About Us</h1>
        <div class="${"about-us-founders svelte-1gpqo79"}"><div><img src="${"/img/founder-one.png"}" alt="${""}" class="${"svelte-1gpqo79"}">
            <h3 class="${"svelte-1gpqo79"}">Name Here</h3>
            <p class="${"svelte-1gpqo79"}">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum
              ab nam commodi officiis eius maiores illum est repudiandae
              accusantium. Quisquam blanditiis provident, distinctio error
              corrupti nemo! Soluta similique voluptatibus sint vel at! Fugit,
              asperiores!
            </p>
            <div class="${"social-media svelte-1gpqo79"}"><div class="${"svelte-1gpqo79"}"><a href="${""}"><img src="${"/img/facebook.svg"}" alt="${""}" class="${"svelte-1gpqo79"}"></a></div>
              <div class="${"svelte-1gpqo79"}"><a href="${""}"><img src="${"/img/instagram.svg"}" alt="${""}" class="${"svelte-1gpqo79"}"></a></div>
              <div class="${"svelte-1gpqo79"}"><a href="${""}"><img src="${"/img/linkedin.svg"}" alt="${""}" class="${"svelte-1gpqo79"}"></a></div></div></div>
          <div><img src="${"/img/founder-two.png"}" alt="${""}" class="${"svelte-1gpqo79"}">
            <h3 class="${"svelte-1gpqo79"}">Name Here</h3>
            <p class="${"svelte-1gpqo79"}">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum
              ab nam commodi officiis eius maiores illum est repudiandae
              accusantium. Quisquam blanditiis provident, distinctio error
            ...
            <div class="${"social-media svelte-1gpqo79"}"><div class="${"svelte-1gpqo79"}"><a href="${""}"><img src="${"/img/facebook.svg"}" alt="${""}" class="${"svelte-1gpqo79"}"></a></div>
              <div class="${"svelte-1gpqo79"}"><a href="${""}"><img src="${"/img/instagram.svg"}" alt="${""}" class="${"svelte-1gpqo79"}"></a></div>
              <div class="${"svelte-1gpqo79"}"><a href="${""}"><img src="${"/img/linkedin.svg"}" alt="${""}" class="${"svelte-1gpqo79"}"></a></div></div></div></div></div></div></div></div>

<div class="${"main-wrap fifth-section"}"><figure class="${"app-img-figure svelte-1gpqo79"}"><img src="${"/img/home-bgs/section-five.svg"}" alt="${""}" class="${"svelte-1gpqo79"}"></figure>
  <div class="${"app-division-wrapper fifth-section-wrapper"}"><div class="${"section-wrapper"}"><div class="${"center-section-wrapper home-contact-us svelte-1gpqo79"}"><h1 class="${"app-decor svelte-1gpqo79"}">Contact Us</h1>
        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Corporis est
          dolor harum recusandae! Nemo unde sed eum quaerat quisquam quo,
          aspernatur voluptas amet!
        </p>
        <form action="${""}" class="${"svelte-1gpqo79"}"><label for="${""}">Email</label>
          <input type="${"text"}" class="${"svelte-1gpqo79"}">
          <button class="${"svelte-1gpqo79"}">Lorem Ipsum</button></form></div></div></div></div>`;
});
